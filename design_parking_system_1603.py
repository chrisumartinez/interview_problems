...
#
# [[428,160,989],[1],[1],[2],[1],[3],[2],[2],[2],[1],[1],[3],[2],[1],[2],[2],[2],[1],[1],[2],[1],[3],[2],[3],[2],[3],[1],[3]]
# Expected: [null,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true]
big = 428
medium = 160
small = 989
addCars = [
